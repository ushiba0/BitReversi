...
export const expand_children_wraper: (a: number, b: number) => [number, number];
export const export_weight_data_wrapper: () => [number, number];
export const get_legal_move_wrapper: (a: number, b: number) => [number, number];
export const get_next_random_move_wrapper: (a: number, b: number) => [number, number];
export const get_state_wrapper: (a: number, b: number) => number;
export const import_weight: (a: number, b: number) => void;
